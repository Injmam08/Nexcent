        ...
        <div className="member col-4">
          <div className="member row-1">
            <div className="member1">
              {" "}
              <img src="../images/icon10.png" alt="icon" /> <h1>2,245,341</h1>
              <p>Members</p>
            </div>
            <div className="member1">
              {" "}
              <img src="../images/icon11.png" alt="icon" />
              <h1 className="text-center">2,245,341</h1> <p>Clubs</p>
            </div>
          </div>
        </div>
        <div className="member1 row-1">
          <div className="member1">
            <img src="../images/icon12.png" alt="icon" />
            <h1>2,245,341</h1> <p>Event Bookings</p>
          </div>
          <div className="member1">
            <img src="../images/icon13.png" alt="icon" />
            <h1>2,245,341</h1> <p>Payments</p>
          </div>
        </div>
